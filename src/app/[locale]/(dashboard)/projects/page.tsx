...
import { CalendarDays, FolderKanban, ExternalLink, WalletCards } from "lucide-react";
...
export default async function ProjectsPage({ searchParams }: { searchParams?: Promise<{ action?: string; q?: string }> }) {
  ...
  return <div className="space-y-6 pb-10">
    <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
      ...
      <ProjectFormDialog contacts={contactOptions} deals={dealOptions} autoOpen={params.action === "new"} />
    </div>
